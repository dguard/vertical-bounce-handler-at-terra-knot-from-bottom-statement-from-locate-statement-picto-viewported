...
function handleProjectAt1stIteration(v1Project, v2Project, /* keep */ profileRatio, frontRatio, debthRatio, i) {
    // keep
    const PROJECTION_CENTER_Y = window['@pencil/draft-terra-knot-from-bottom-statement']['passThroughFromBottom']['PROJECTION_CENTER_Y']

    const PROJECTION_CENTER_X = window['@pencil/draft-terra-knot-from-bottom-statement']['passThroughFromBottom']['PROJECTION_CENTER_X']
...
window['@pencil/draft-handle-terra-knot-from-bottom-statement'] = {
