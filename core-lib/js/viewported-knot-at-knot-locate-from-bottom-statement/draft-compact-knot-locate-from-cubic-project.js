...
function RectangleOnPaper(radius, frontRatio, p, d, debthScaleRatio, profileScaleRatio, frontScaleRatio) {
    ...
    const FIELD_OF_VIEW = window['@pencil/draft-knot-locate-from-cubic-project']['passThroughFromBottom']['FIELD_OF_VIEW']

    const PROJECTION_CENTER_Y = window['@pencil/draft-knot-locate-from-cubic-project']['passThroughFromBottom']['PROJECTION_CENTER_Y']

    const PROJECTION_CENTER_X = window['@pencil/draft-knot-locate-from-cubic-project']['passThroughFromBottom']['PROJECTION_CENTER_X']
    ...
    that.draw = function () {
        ...
        const handleProjectAt1stIteration = window['@pencil/handle-knot-locate-from-cubic-project']['handleProjectAt1stIteration']
        const handleProjectAt2ndIteration = window['@pencil/handle-knot-locate-from-cubic-project']['handleProjectAt2ndIteration']
        ...
        for(let i = 0; i < lines.length; i++) {
            ...
            let ctx = window['@pencil/draft-knot-locate-from-cubic-project']['passThroughFromBottom']['canvas']
...
window['@pencil/draft-compact-knot-locate-from-cubic-project'] = {
    DraftFabrikk,
    Pencil
}
