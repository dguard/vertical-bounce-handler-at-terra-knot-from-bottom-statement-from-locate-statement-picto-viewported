...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-locate-from-cubic-project']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-locate-from-cubic-project']['DraftFabrikk']
    ...
    passThrough['@pencil/draft-knot-locate-from-cubic-project'] = function (spawnedPointerBelongings) {
...
// keep !
passThroughFromBottom['@pencil/draft-knot-locate-from-cubic-project']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-locate-from-cubic-project']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-locate-from-cubic-project']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-locate-from-cubic-project']['canvas'] = ctx
...
// keep
window['@pencil/draft-knot-locate-from-cubic-project'] = {
    passThrough: passThrough['@pencil/draft-knot-locate-from-cubic-project'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-locate-from-cubic-project']
}
// keep
